...
Un premier non maintenu (voir le ticket [#5 de monitoring2.0](https://git.fdn.fr/adminsys/monitoring2.0/-/issues/5)) hébergé en interne (sur [cecinestpasleia](./infra/machines/leia.md)) et un second gentiment hébergé à l'extérieur de l'infra de FDN sur skytop, une VM hébergée chez Grenode (voir [page dédiée](./outils_internes/supervision/remote_monitoring.md)).
